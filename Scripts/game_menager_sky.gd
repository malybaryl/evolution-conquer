...
func transform_to_fish_level():
	...
	for enemy in enemies:
		enemy.scale.x = .3
		enemy.scale.y = .3
	var player_animator = get_node("/root/SkyLevel/Player/Area2D/AnimatedSprite2D")
